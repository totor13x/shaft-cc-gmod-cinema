CreateConVar( "cinema_url", "https://shaft.im/apps/cinema/index.php", FCVAR_REPLICATED, "Cinema url to load on theater screens." )
	...
	*/
	hook.Add( "PlayerSay", "TheaterAutoAdd", function( ply, chat )
		...
		if Theater then
			...
			local fixprice = chat[1] and chat[2] and chat[1]..chat[2]
			if (fixprice == '!!') then
				Theater:RequestVideo( ply, string.sub(chat,3) )
			end
