surface.CreateFont( "ScoreboardTheaterName", { font = "Open Sans Light", size = 30, weight = 100 } )
surface.CreateFont( "ScoreboardTheaterTime", { font = "Open Sans Light", size = 16, weight = 600 } )
surface.CreateFont( "ScoreboardTheaterVideo", { font = "Open Sans Light", size = 16, weight = 200 } )
