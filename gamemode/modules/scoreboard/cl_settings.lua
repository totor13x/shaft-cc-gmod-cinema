...
surface.CreateFont( "ScoreboardHelp", { font = "Open Sans Light", size = 20, weight = 100 } )
surface.CreateFont( "ScoreboardHelpSmall", { font = "Open Sans Light", size = 18, weight = 100 } )
...
function SETTINGS:Create()
	...
	HidePlayers:SetSize(256,20)
	HidePlayers:AlignTop( self.TitleHeight + 67 )
