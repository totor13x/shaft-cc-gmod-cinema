surface.CreateFont( "ScoreboardTitle", { font = "Open Sans Light", size = 50, weight = 400 } )
surface.CreateFont( "ScoreboardTitleSmall", { font = "Open Sans Light", size = 28, weight = 100 } )
surface.CreateFont( "ScoreboardTitleSmaller", { font = "Open Sans Light", size = 18, weight = 100 } )
surface.CreateFont( "ScoreboardServerName", { font = "Open Sans Light", size = 28, weight = 200 } )
surface.CreateFont( "ScoreboardMapName", { font = "Open Sans Light", size = 22, weight = 200 } )
surface.CreateFont( "ScoreboardName", { font = "Open Sans Light", size = 20, weight = 800 } )
surface.CreateFont( "ScoreboardLocation", { font = "Open Sans Light", size = 16, weight = 200 } )
surface.CreateFont( "ScoreboardPing", { font = "Open Sans Light", size = 18, weight = 200 } )
